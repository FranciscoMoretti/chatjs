...
> clipped) …
> **Intended changes (11)** — content changed, looks correct, accept candidates: `Hero/Default` (14%,
> new headline copy), …
> **Cosmetic reflow (9)** — real pixels, vertical shift only: `EventStatusCard/All Variants` (4.1%,
> rows shifted ~5px), `TestingInit/Playground` (3.7%), …
> **Chart anti-aliasing noise (6)** — sub-0.4% edge jitter, safe to accept: `FunnelChart/Smaller
